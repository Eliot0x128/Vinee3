        ...
        <div className="relative mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              ...
              <div className="flex flex-row mt-12 gap-5">
                <input className="border-[#403D42] border bg-transparent py-5 px-5 w-40 rounded-md" placeholder="Referral Code"></input>
                <input className="border-[#403D42] border bg-transparent py-5 px-5 w-60 rounded-md" placeholder="E-Mail"></input>
              </div>
          ...
          <div className="flex flex-row gap-5">
            <img src="./img/intro-frame-1.png"></img>
