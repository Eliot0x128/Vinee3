      ...
      <div className="w-screen relative">
        <div className="relative max-w-7xl flex flex-col sm:flex-row mx-auto justify-between">
            <div className="justify-center flex flex-col gap-3 mx-8">
                ...
                <p className="text-[#867D8B] max-w-sm">The comprehensive distribution of Winee3 Token is meticulously illustrated in the chart that follows, offering a clear and detailed breakdown of how tokens are allocated and circulate within our platform. This commitment to transparency ensures that all users can fully understand the token's journey and its significance in our ecosystem.</p>
